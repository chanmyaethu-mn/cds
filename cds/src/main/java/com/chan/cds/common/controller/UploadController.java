package com.chan.cds.common.controller;
	...
	public void uploadImage(@RequestParam("upload") MultipartFile file, HttpServletRequest request,
		...
		if (!file.isEmpty()) {
			try {
				...
				// 解决跨域问题
				// Refused to display
				// 'http://localhost:8080/upload/mgmt/img?CKEditor=practice_content&CKEditorFuncNum=1&langCode=zh-cn'
				...
				String input_name=request.getParameter("upload");
